...
//      var validvid524113= $('#vid').val() === '524 113';
        ...
        if (vid_encoded == "IDM3NA==") {
            window.location.replace("./pages/691374.html")
        }
        else if (vid_encoded == "IDYzNw==") {
            window.location.replace("./pages/187637.html")
        }
        else if (vid_encoded == "IDM3NQ==") {
            window.location.replace("./pages/691375.html")
        }
        else if (vid_encoded == "IDExMw==") {
            window.location.replace("./pages/524113.html")
        }
        else {
            window.location.replace("./pages/idnotfound.html")}
